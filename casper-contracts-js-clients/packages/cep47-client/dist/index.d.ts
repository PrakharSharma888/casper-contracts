...
export declare class CEP47Client {
    ...
    name(): Promise<import("casper-js-sdk").StoredValue>;
    symbol(): Promise<import("casper-js-sdk").StoredValue>;
    meta(): Promise<import("casper-js-sdk").StoredValue>;
    totalSupply(): Promise<import("casper-js-sdk").StoredValue>;
